            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local HpInc, AtckInc, DefInc, SpeedInc = self.playerPokemon:levelUp()
                        local StatItems = {
                            {
                                text = 'Hp:' ..self.playerPokemon.HP - HpInc.. '+' ..HpInc.. '=' ..self.playerPokemon.HP   
                            },
                            {
                                text = 'Atk:' ..self.playerPokemon.attack - AtckInc.. '+' ..AtckInc.. '=' ..self.playerPokemon.attack
                            },
                            {
                                text = 'Def:' ..self.playerPokemon.defense - DefInc.. '+' ..DefInc.. '=' ..self.playerPokemon.defense
                            },
                            {
                                text = 'Speed:' ..self.playerPokemon.speed - SpeedInc.. '+' ..SpeedInc.. '=' ..self.playerPokemon.speed
                            },                            
                        }
                        ...
                        gStateStack:push(BattleLevelUpMenuState({
                            statList = StatItems 
                        }))
